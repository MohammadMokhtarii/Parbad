...
namespace Parbad
{
    public class RefundInvoice
    {
        ...
        public RefundInvoice(string trackingNumber, decimal amount = 0)
        {
            if (trackingNumber.IsNullOrEmpty()) throw new ArgumentOutOfRangeException(nameof(trackingNumber));
